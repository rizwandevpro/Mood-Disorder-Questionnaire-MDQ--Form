...
export const INTAKE_STEPS = [
  ...
  // ── Step 3: Demographics ──────────────────────────────────────────────────
  {
    ...
    fields: [
      { key: "pharmacy",        label: "Pharmacy Name / Location", type: "text", placeholder: "Pharmacy name and location", required: false, span: "full" },
      { key: "race",            label: "Race",                     type: "text", placeholder: "Race",                      required: false, span: "third" },
      { key: "ethnicity",       label: "Ethnicity",                type: "text", placeholder: "Ethnicity",                 required: false, span: "third" },
      { key: "primaryLanguage", label: "Primary Language",         type: "text", placeholder: "Primary language",          required: false, span: "third" },
    ],
  },
